...
public:
    ...
    struct queue_item;
    Alphabeta::eval_move eval_tree[100];
    int eval_piece(int piece);
    int eval_board(int color);
    Alphabeta::eval_move start_alphabeta(int color, int attacking_only);
    ...
    int get_all_moves(
        ...
        std::priority_queue<queue_item, std::vector<queue_item>, Compare>& list,
        int attacking);
    Alphabeta(Move* move, int depth, int quise);
    int depth = 5;
    int max_quise;
    int debug_test = 0;
